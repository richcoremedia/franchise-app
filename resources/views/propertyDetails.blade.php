							...
							<div class="col_full nobottommargin">
								...
								<div class="col_full nobottommargin">
									...
									{!! Form::open(['url' => '/propertyDetails/'.$id, 'method' => 'POST']) !!}
								          ...
								          {!! Form::text('price', null, array('class' => 'sm-form-control')) !!}

								          {!! Form::label('city', 'City') !!}
								          {!! Form::text('city', null, array('class' => 'sm-form-control')) !!}

								          {!! Form::submit('Submit', array('class' => 'button button-3d nomargin')) !!}
