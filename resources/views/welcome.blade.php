...
@section('contents')
			...
			<div class="full-screen" style="background: url('images/appshowcase/1.jpg'); background-size: cover;">
				<div class="container clearfix">
					...
					<div class="vertical-middle no-fade">
						...
						<div class="col_full dark fright nobottommargin" data-animate="fadeIn">
	...
	<section id="content">
		...
		<div class="content-wrap">			
			...
			<div class="notopmargin nobottommargin clearfix">
				<div class="container clearfix">
			...
			<div class="section notopmargin nobottommargin clearfix">
				<div class="container clearfix">
					...
					<div class="col_half nobottommargin topmargin-sm">
						...
						<img src="images/property/agent-shake.png" alt="Image" class="center-block">
					...
					<div class="col_half nobottommargin topmargin-sm col_last">
						...
						<p>Selling a property is not an easy task. You will need to find the correct buyer that are willing to buy your property. Leave everything to us, and in no time your property will be reached around the country.</p>
			...
			<div class="nobottommargin notopmargin clearfix">
				<div class="container clearfix">
